...
public class MoveMaker {
	...
	private void initMap(){
		...
		map.put(new VerticalStripedCandy() + new Hazelnut().getKey(), new CandyMove(grid));
		...
		map.put(new Bomb() + new Hazelnut().getKey(), new CandyMove(grid));
		map.put(new Bomb() + new Cherry().getKey(), new CandyMove(grid));
